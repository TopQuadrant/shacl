...
import org.topbraid.shacl.model.SHACLPredicateBasedConstraint;
import org.topbraid.shacl.vocabulary.SH;
import org.topbraid.spin.util.JenaUtil;

public abstract class SHACLPredicateBasedConstraintImpl extends SHACLParameterizableConstraintImpl implements SHACLPredicateBasedConstraint {
	
	public SHACLPredicateBasedConstraintImpl(Node node, EnhGraph graph) {
		super(node, graph);
	}
